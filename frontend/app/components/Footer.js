    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* À propos */}
          <div>
            <h3 className="text-xl font-bold mb-4">À propos de Tapakila</h3>
            <p className="text-gray-400">
              Votre plateforme de billetterie événementielle de confiance. Réservez facilement vos billets pour les meilleurs événements.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>Email: contact@tapakila.com</li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Tapakila. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  );
